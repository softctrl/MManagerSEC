    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_currencies:
                ...
                intent = new Intent(this, br.com.softctrl.mmanagersec.app.currency.list.CurrencyListActivity.class);
                intent.setAction(Intent.ACTION_EDIT);
                startActivity(intent);
                break;

            case MenuHelper.edit:
                intent = new Intent(this, br.com.softctrl.mmanagersec.app.assetallocation.editor.AssetAllocationEditorActivity.class);
                startActivity(intent);
                break;
