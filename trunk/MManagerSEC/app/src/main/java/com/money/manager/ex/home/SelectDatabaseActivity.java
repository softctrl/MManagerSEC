...
import br.com.softctrl.mmanagersec.app.home.CreateDatabaseActivity;
...
//    public static final int REQUEST_PICKFILE = 1;
    ...
    void onSetupSyncClick() {
        Intent intent = new Intent(this, br.com.softctrl.mmanagersec.app.settings.SyncPreferencesActivity.class);
        startActivity(intent);
    }
