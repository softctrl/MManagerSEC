...
import br.com.softctrl.mmanagersec.app.home.SelectDatabaseActivity;
import dagger.Lazy;
...
public class MainActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent serviceRepeatingTransaction = new Intent(getApplicationContext(), br.com.softctrl.mmanagersec.app.core.RecurringTransactionBootReceiver.class);
    ...
    protected void onStart() {
        ...
        if (!isAuthenticated) {
            ...
            if (passcode.hasPasscode() && !isInAuthentication) {
                Intent intent = new Intent(this, br.com.softctrl.mmanagersec.app.PasscodeActivity.class);
                // set action and data
    ...
    public boolean onDrawerMenuAndOptionMenuSelected(DrawerMenuItem item) {
        ...
        switch (item.getId()) {
            ...
            case R.id.menu_currency:
                // Show Currency list.
                intent = new Intent(MainActivity.this, br.com.softctrl.mmanagersec.app.currency.list.CurrencyListActivity.class);
//                intent = new Intent(MainActivity.this, CurrencyRecyclerListActivity.class);
            ...
            case R.id.menu_budgets:
                intent = new Intent(this, br.com.softctrl.mmanagersec.app.budget.BudgetsActivity.class);
                startActivity(intent);
                break;
            case R.id.menu_asset_allocation:
                intent = new Intent(this, br.com.softctrl.mmanagersec.app.assetallocation.overview.AssetAllocationOverviewActivity.class);
                startActivity(intent);
                break;
            case R.id.menu_search_transaction:
                startActivity(new Intent(MainActivity.this, br.com.softctrl.mmanagersec.app.search.SearchActivity.class));
                break;
            case R.id.menu_report_categories:
                startActivity(new Intent(this, br.com.softctrl.mmanagersec.app.reports.CategoriesReportActivity.class));
                break;
            case R.id.menu_settings:
                startActivity(new Intent(MainActivity.this, br.com.softctrl.mmanagersec.app.settings.SettingsActivity.class));
                break;
            case R.id.menu_reports:
                showReportsSelector(item.getText());
                break;
            case R.id.menu_report_payees:
                startActivity(new Intent(this, br.com.softctrl.mmanagersec.app.reports.PayeesReportActivity.class));
                break;
            case R.id.menu_report_where_money_goes:
                intent = new Intent(this, br.com.softctrl.mmanagersec.app.reports.CategoriesReportActivity.class);
            ...
            case R.id.menu_report_income_vs_expenses:
                startActivity(new Intent(this, br.com.softctrl.mmanagersec.app.reports.IncomeVsExpensesActivity.class));
                break;
            case R.id.menu_asset_allocation_overview:
                startActivity(new Intent(this, br.com.softctrl.mmanagersec.app.assetallocation.AssetAllocationReportActivity.class));
                break;
            case R.id.menu_help:
                startActivity(new Intent(MainActivity.this, br.com.softctrl.mmanagersec.app.HelpActivity.class));
                break;
            case R.id.menu_about:
                startActivity(new Intent(MainActivity.this, br.com.softctrl.mmanagersec.app.about.AboutActivity.class));
                break;
            case R.id.menu_donate:
                startActivity(new Intent(this, br.com.softctrl.mmanagersec.app.DonateActivity.class));
                break;
            default:
...
//    }
    ...
    public void showTutorial() {
        Intent intent = new Intent(this, br.com.softctrl.mmanagersec.app.tutorial.TutorialActivity.class);
