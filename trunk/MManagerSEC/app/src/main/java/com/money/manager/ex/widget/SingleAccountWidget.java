...
import br.com.softctrl.mmanagersec.app.BuildConfig;
...
//        String accountName = getAccountName(context, accountId);
    ...
    private void initializeNewTransactionCommand(Context context, RemoteViews views) {
        Intent intent = new Intent(context, br.com.softctrl.mmanagersec.app.transactions.CheckingTransactionEditActivity.class);
...
//        RemoteViews views = new RemoteViews(context.getPackageName(),R.layout.appwidget_provider_layout);
    ...
    private void initializeRefreshDataCommand(Context context, RemoteViews views, int appWidgetId) {
        ...
        Intent intent = new Intent(context, br.com.softctrl.mmanagersec.app.widget.SingleAccountWidget.class);
