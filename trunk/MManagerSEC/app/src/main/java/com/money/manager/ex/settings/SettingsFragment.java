...
public class SettingsFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (perDbPreference != null) {
            ...
            perDbPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference preference) {
                    Intent intent = new Intent(getActivity(), br.com.softctrl.mmanagersec.app.settings.SettingsActivity.class);
        ...
        if (lookAndFeelPreference != null) {
            ...
            lookAndFeelPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    startActivity(new Intent(getActivity(), br.com.softctrl.mmanagersec.app.settings.LookFeelSettingsActivity.class));
                    return true;
                }
            });
        }
        ...
        if (behaviourPreference != null) {
            ...
            behaviourPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    startActivity(new Intent(getActivity(), br.com.softctrl.mmanagersec.app.settings.BehaviourSettingsActivity.class));
                    return true;
                }
            });
        }
        ...
        if (investmentPreference != null) {
            ...
            investmentPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    startActivity(new Intent(getActivity(), br.com.softctrl.mmanagersec.app.settings.InvestmentSettingsActivity.class));
                    return true;
                }
            });
        }
        ...
        if (budgetPreference != null) {
            ...
            budgetPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    startActivity(new Intent(getActivity(), br.com.softctrl.mmanagersec.app.settings.BudgetSettingsActivity.class));
                    return true;
                }
            });
        }
        ...
        if (passcodePreference != null) {
            ...
            passcodePreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    startActivity(new Intent(getActivity(), br.com.softctrl.mmanagersec.app.settings.SecuritySettingsActivity.class));
                    return true;
                }
            });
        }
        ...
        if (databasesPreference != null) {
            ...
            databasesPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    startActivity(new Intent(getActivity(), br.com.softctrl.mmanagersec.app.settings.DatabaseSettingsActivity.class));
                    return true;
                }
            });
        }
        ...
        if (syncPreference != null) {
            ...
            syncPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    startActivity(new Intent(getActivity(), br.com.softctrl.mmanagersec.app.settings.SyncPreferencesActivity.class));
                    return true;
                }
            });
        }
        ...
        if (pDonate != null) {
            ...
            pDonate.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    startActivity(new Intent(getActivity(), br.com.softctrl.mmanagersec.app.DonateActivity.class));
                    return false;
                }
            });
        }
        ...
        if (infoPreference != null) {
            ...
            infoPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    startActivity(new Intent(getActivity(), br.com.softctrl.mmanagersec.app.about.AboutActivity.class));
                    return true;
                }
            });
        }
    ...
    private void initGeneralSettings() {
        ...
        generalPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                Intent intent = new Intent(getActivity(), br.com.softctrl.mmanagersec.app.settings.GeneralSettingsActivity.class);
