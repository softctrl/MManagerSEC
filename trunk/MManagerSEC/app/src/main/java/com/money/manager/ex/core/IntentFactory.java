...
public class IntentFactory {
    public static Intent getSyncServiceIntent(Context context, String action, String localFile,
        ...
        Intent syncServiceIntent = new Intent(context, br.com.softctrl.mmanagersec.app.sync.SyncService.class);
    ...
    public static Intent getSearchIntent(Context context, SearchParameters parameters) {
        Intent intent = new Intent(context, br.com.softctrl.mmanagersec.app.search.SearchActivity.class);
    ...
    public static Intent getMainActivityNew(Context context) {
        Intent intent = new Intent(context, br.com.softctrl.mmanagersec.app.home.MainActivity.class);
...
//        intent.addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY);
    ...
    public static Intent getPriceEditIntent(Context context) {
        Intent intent = new Intent(context, br.com.softctrl.mmanagersec.app.investment.PriceEditActivity.class);
