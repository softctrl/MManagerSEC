...
import br.com.softctrl.mmanagersec.app.widget.AccountBillsWidgetService;
...
public class AccountBillsWidgetProvider
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager,
        ...
        for (int i = 0; i < appWidgetIds.length; ++i) {
            ...
            Intent intentApplication = new Intent(context, br.com.softctrl.mmanagersec.app.home.MainActivity.class);
            ...
            Intent intentRefresh = new Intent(context, br.com.softctrl.mmanagersec.app.widget.AccountBillsWidgetProvider.class);
